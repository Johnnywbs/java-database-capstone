...
public class Prescription {
    ...
    private Long appointmentId; // Referência ao ID (Long) da entidade Appointment no MySQL
    ...
    // Campo opcional: Sem @NotNull, apenas validação de tamanho máximo
    @Size(max = 200, message = "As notas do médico não podem exceder 200 caracteres")
    private String doctorNotes;

    // Construtor Padrão (Obrigatório para Spring Data)
    public Prescription() {
    }

    // Construtor com campos obrigatórios (Facilita a criação)
